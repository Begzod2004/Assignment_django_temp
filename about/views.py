...
from .models import CompanyInfo, Facts, Service, Employee, News, Testimonial
...
def posts(request):
	...
	return render(request, 'about/posts.html', context)
...
def createPost(request):
	...
	context = {'form':form}
	return render(request, 'about/post_form.html', context)
...
def sendEmail(request):
	...
	if request.method == 'POST':
		...
		template = render_to_string('about/email_template.html', {
	...
	return render(request, 'about/email_sent.html')
...
def userAccount(request):
	...
	return render(request, 'about/account.html', context)
...
def updateProfile(request):
	...
	context = {'form':form}
	return render(request, 'about/profile_form.html', context)